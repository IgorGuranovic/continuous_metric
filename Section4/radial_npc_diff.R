...
genes_of_interest <- c("ID3","ITPR1","NOTCH2","GXYLT2","PAX2","ID1","RXRA","DNM1","LYPD1") #leaving HIST1H1A, TYMS, CENPU, TOP2A for prolif block
...
ggsave("npc_diff.tiff", plot = p5, width = 8, height = 8, dpi = 300, device = "tiff",
       compression = "lzw")

message("Nature-ified filled polar plot generated: ", file.path(output_dir, "npc_diff.tiff"))